...
|-----------|------------|------------------|-----------------|---------------|----------|----------|--------|
| graph_01.txt | CSR Graph | V = ___ , E = ___ | Traversal sequence | Traversal sequence | ___ ms | ___ ms | Pass |
| graph_02.txt | CSR Graph | V = ___ , E = ___ | Traversal sequence | Traversal sequence | ___ ms | ___ ms | Pass |
...
|-----------|------------|------------------|---------------|-----------------|---------------|----------------|--------|
| sssp_test_01.txt | Weighted CSR Graph | V = ___ , E = ___ | ___ | Shortest distances | Shortest distances | ___ ms | Pass |
| sssp_test_02.txt | Weighted CSR Graph | V = ___ , E = ___ | ___ | Shortest distances | Shortest distances | ___ ms | Pass |
...
because every vertex and every edge is visited once.
...
The implemented Dijkstra algorithm uses linear search for selecting minimum distance vertex.
